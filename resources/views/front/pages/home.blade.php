    ...
    <ul class="cart-list">
        <li class="cart-item">
            <div class="cart-media">
                <a href="#"><img src="{{ url('/') }}/frontend/images/product/01.jpg" alt="product"></a>
        ...
        <li class="cart-item">
            <div class="cart-media">
                <a href="#"><img src="{{ url('/') }}/frontend/images/product/02.jpg" alt="product"></a>
                <button class="cart-delete"><i class="far fa-trash-alt"></i></button>
            </div>
            <div class="cart-info-group">
                <div class="cart-info">
        ...
        <li class="cart-item">
            <div class="cart-media">
                <a href="#"><img src="{{ url('/') }}/frontend/images/product/03.jpg" alt="product"></a>
                <button class="cart-delete"><i class="far fa-trash-alt"></i></button>
            </div>
            <div class="cart-info-group">
                <div class="cart-info">
        ...
        <li class="cart-item">
            <div class="cart-media">
                <a href="#"><img src="{{ url('/') }}/frontend/images/product/04.jpg" alt="product"></a>
                <button class="cart-delete"><i class="far fa-trash-alt"></i></button>
            </div>
            <div class="cart-info-group">
                <div class="cart-info">
        ...
        <li class="cart-item">
            <div class="cart-media">
                <a href="#"><img src="{{ url('/') }}/frontend/images/product/05.jpg" alt="product"></a>
                <button class="cart-delete"><i class="far fa-trash-alt"></i></button>
            </div>
            <div class="cart-info-group">
                <div class="cart-info">
...
<aside class="nav-sidebar">
    <div class="nav-header">
        <a href="#"><img src="{{ url('/') }}/frontend/images/logo.png" alt="logo"></a>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="view-gallery">
                            ...
                            <ul class="preview-slider slider-arrow">
                                <li><img src="{{ url('/') }}/frontend/images/product/01.jpg" alt="product"></li>
                                <li><img src="{{ url('/') }}/frontend/images/product/01.jpg" alt="product"></li>
                                <li><img src="{{ url('/') }}/frontend/images/product/01.jpg" alt="product"></li>
                                <li><img src="{{ url('/') }}/frontend/images/product/01.jpg" alt="product"></li>
                                <li><img src="{{ url('/') }}/frontend/images/product/01.jpg" alt="product"></li>
            ...
            <div class="col-lg-3">
                <div class="banner-category">
                    ...
                    <ul class="banner-category-list">
                        ...
                        <li class="banner-category-item"><a href="#"><i class="flaticon-groceries"></i><span>groceries</span></a>
                            <div class="banner-category-dropdown">
                        ...
                        <li class="banner-category-item"><a href="#"><i class="flaticon-dairy-products"></i><span>dairy farms</span></a>
                            <div class="banner-category-dropdown">
                                <h5>dairy items</h5>
                                <div class="banner-sub-category">
                                    <ul>
                        ...
                        <li class="banner-category-item"><a href="#"><i class="flaticon-crab"></i><span>sea foods</span></a>
                            <div class="banner-category-dropdown">
                        ...
                        <li class="banner-category-item"><a href="#"><i class="flaticon-salad"></i><span>diet foods</span></a>
                            <div class="banner-category-dropdown">
                        ...
                        <li class="banner-category-item"><a href="#"><i class="flaticon-dried-fruit"></i><span>dry foods</span></a>
                            <div class="banner-category-dropdown">
                        ...
                        <li class="banner-category-item"><a href="#"><i class="flaticon-fast-food"></i><span>fast foods</span></a>
                            <div class="banner-category-dropdown">
                        ...
                        <li class="banner-category-item"><a href="#"><i class="flaticon-cheers"></i><span>drinks</span></a>
                            <div class="banner-category-dropdown">
                                <h5>drinks item</h5>
                                <div class="banner-sub-category">
                                    <ul>
                        ...
                        <li class="banner-category-item"><a href="#"><i class="flaticon-barbecue"></i><span>meats</span></a>
                            <div class="banner-category-dropdown">
                                <h5>meats item</h5>
                                <div class="banner-sub-category">
                                    <ul>
                        ...
                        <li class="banner-category-item"><a href="#"><i class="flaticon-fish"></i><span>fishes</span></a>
                            <div class="banner-category-dropdown">
                                <h5>fishes item</h5>
                                <div class="banner-sub-category">
                                    <ul>
                ...
                <div class="row">
                        ...
                        <div class="home-grid-slider slider-dots">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-6 col-lg-6">
                                        <div class="banner-content">
                                            <h2>we are delivered organic foods item within 24 hours.</h2><a href="#" class="btn btn-inline"><i class="fas fa-shopping-basket"></i><span>shop now</span></a></div>
                                    </div>
                                    <div class="col-md-6 col-lg-6">
                                        <div class="banner-image"><img src="{{ url('/') }}/frontend/images/home/index/01.png" alt=""></div>
                                    </div>
                                </div>
                            </div>
                            <div class="banner-wrap bg2">
                                <div class="row align-items-center">
                                    <div class="col-md-6 col-lg-6">
                                        <div class="banner-content">
                                            <h2>get your organic healthy foods item online today.</h2><a href="#" class="btn btn-inline"><i class="fas fa-shopping-basket"></i><span>shop now</span></a></div>
                                    </div>
                                    <div class="col-md-6 col-lg-6">
                                        <div class="banner-image"><img src="{{ url('/') }}/frontend/images/home/index/02.png" alt=""></div>
                                    </div>
                                </div>
                            </div>
                            <div class="banner-wrap bg3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <div class="banner-image"><img src="{{ url('/') }}/frontend/images/home/index/03.png" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="banner-promo">
                            <a href="#"><img src="{{ url('/') }}/frontend/images/promo/home/04.jpg" alt="promo"></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <div class="banner-promo">
                            <a href="#"><img src="{{ url('/') }}/frontend/images/promo/home/05.jpg" alt="promo"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="product-card">
                    <div class="product-media">
                        ...
                        <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/01.jpg" alt="product"></a>
            ...
            <div class="col">
                <div class="product-card">
                    <div class="product-media">
                        ...
                        <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                        <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/02.jpg" alt="product"></a>
                        <div class="product-widget">
                            <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                            <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                            <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
            ...
            <div class="col">
                <div class="product-card">
                    <div class="product-media">
                        ...
                        <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                        <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/03.jpg" alt="product"></a>
                        <div class="product-widget">
                            <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                            <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                            <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
            ...
            <div class="col">
                <div class="product-card">
                    <div class="product-media">
                        ...
                        <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                        <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/04.jpg" alt="product"></a>
                        <div class="product-widget">
                            <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                            <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                            <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
            ...
            <div class="col">
                <div class="product-card">
                    <div class="product-media">
                        ...
                        <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                        <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/05.jpg" alt="product"></a>
                        <div class="product-widget">
                            <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                            <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                            <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
            ...
            <div class="col">
                <div class="product-card">
                    <div class="product-media">
                        ...
                        <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                        <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/06.jpg" alt="product"></a>
                        <div class="product-widget">
                            <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                            <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                            <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
            ...
            <div class="col">
                <div class="product-card">
                    <div class="product-media">
                        ...
                        <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                        <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/07.jpg" alt="product"></a>
                        <div class="product-widget">
                            <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                            <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                            <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
            ...
            <div class="col">
                <div class="product-card">
                    <div class="product-media">
                        ...
                        <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                        <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/08.jpg" alt="product"></a>
                        <div class="product-widget">
                            <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                            <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                            <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
            ...
            <div class="col">
                <div class="feature-card">
                    <div class="feature-media">
                        ...
                        <a class="feature-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/09.jpg" alt="product"></a>
            ...
            <div class="col">
                <div class="feature-card">
                    <div class="feature-media">
                        ...
                        <button class="feature-wish wish"><i class="fas fa-heart"></i></button>
                        <a class="feature-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/10.jpg" alt="product"></a>
                        <div class="feature-widget">
                            <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                            <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                            <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
            ...
            <div class="col">
                <div class="feature-card">
                    <div class="feature-media">
                        ...
                        <button class="feature-wish wish"><i class="fas fa-heart"></i></button>
                        <a class="feature-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/11.jpg" alt="product"></a>
                        <div class="feature-widget">
                            <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                            <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                            <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
            ...
            <div class="col">
                <div class="feature-card">
                    <div class="feature-media">
                        ...
                        <button class="feature-wish wish"><i class="fas fa-heart"></i></button>
                        <a class="feature-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/12.jpg" alt="product"></a>
                        <div class="feature-widget">
                            <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                            <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                            <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
            ...
            <div class="col">
                <div class="feature-card">
                    <div class="feature-media">
                        ...
                        <button class="feature-wish wish"><i class="fas fa-heart"></i></button>
                        <a class="feature-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/13.jpg" alt="product"></a>
                        <div class="feature-widget">
                            <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                            <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                            <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
            ...
            <div class="col">
                <div class="feature-card">
                    <div class="feature-media">
                        ...
                        <button class="feature-wish wish"><i class="fas fa-heart"></i></button>
                        <a class="feature-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/14.jpg" alt="product"></a>
                        <div class="feature-widget">
                            <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                            <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                            <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="promo-content" style="background: url('images/promo/home/09.jpg') no-repeat center;">
                    ...
                    <h2>fresh Blueberries</h2><a href="shop-4column.html" class="btn btn-inline"><i class="fas fa-shopping-basket"></i><span>shop now</span></a></div>
            </div>
        </div>
    </div>
</section>
                    ...
                    <li>
                        <div class="product-card">
                            <div class="product-media">
                                ...
                                <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                                <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/15.jpg" alt="product"></a>
                                <div class="product-widget">
                                    <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                    <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                                    <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
                    ...
                    <li>
                        <div class="product-card">
                            <div class="product-media">
                                ...
                                <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                                <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/16.jpg" alt="product"></a>
                                <div class="product-widget">
                                    <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                    <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                                    <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
                    ...
                    <li>
                        <div class="product-card">
                            <div class="product-media">
                                ...
                                <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                                <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/17.jpg" alt="product"></a>
                                <div class="product-widget">
                                    <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                    <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                                    <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
                    ...
                    <li>
                        <div class="product-card">
                            <div class="product-media">
                                ...
                                <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                                <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/18.jpg" alt="product"></a>
                                <div class="product-widget">
                                    <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                    <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                                    <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
                    ...
                    <li>
                        <div class="product-card">
                            <div class="product-media">
                                ...
                                <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                                <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/19.jpg" alt="product"></a>
                                <div class="product-widget">
                                    <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                    <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                                    <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
                    ...
                    <li>
                        <div class="product-card">
                            <div class="product-media">
                                ...
                                <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                                <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/20.jpg" alt="product"></a>
                                <div class="product-widget">
                                    <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                    <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                                    <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                            <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/09.jpg" alt="product"></a>
                            <div class="product-widget">
                                <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                                <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                            <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/10.jpg" alt="product"></a>
                            <div class="product-widget">
                                <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                                <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                            <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/11.jpg" alt="product"></a>
                            <div class="product-widget">
                                <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                                <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                            <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/12.jpg" alt="product"></a>
                            <div class="product-widget">
                                <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                                <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                            <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/13.jpg" alt="product"></a>
                            <div class="product-widget">
                                <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                                <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button>
                            <a class="product-image" href="product-video.html"><img src="{{ url('/') }}/frontend/images/product/14.jpg" alt="product"></a>
                            <div class="product-widget">
                                <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                                <a title="Product View" href="#" class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#product-view"></a>
            ...
            <div class="col-lg-12">
                <div class="category-slider slider-arrow">
                    <div class="category-wrap">
                        <div class="category-media"><img src="{{ url('/') }}/frontend/images/category/dairy.jpg" alt="category">
                    ...
                    <div class="category-wrap">
                        <div class="category-media"><img src="{{ url('/') }}/frontend/images/category/vegetables.jpg" alt="category">
                            <div class="category-overlay"><a href="shop-4column.html"><i class="fas fa-link"></i></a></div>
                        </div>
                        <div class="category-meta">
                    ...
                    <div class="category-wrap">
                        <div class="category-media"><img src="{{ url('/') }}/frontend/images/category/drinks.jpg" alt="category">
                            <div class="category-overlay"><a href="shop-4column.html"><i class="fas fa-link"></i></a></div>
                        </div>
                        <div class="category-meta">
                            <h4>coffe & drinks</h4>
                    ...
                    <div class="category-wrap">
                        <div class="category-media"><img src="{{ url('/') }}/frontend/images/category/fish.jpg" alt="category">
                            <div class="category-overlay"><a href="shop-4column.html"><i class="fas fa-link"></i></a></div>
                        </div>
                        <div class="category-meta">
                            <h4>fish items</h4>
                    ...
                    <div class="category-wrap">
                        <div class="category-media"><img src="{{ url('/') }}/frontend/images/category/groceries.jpg" alt="category">
                            <div class="category-overlay"><a href="shop-4column.html"><i class="fas fa-link"></i></a></div>
                        </div>
                        <div class="category-meta">
                            <h4>grocery items</h4>
                    ...
                    <div class="category-wrap">
                        <div class="category-media"><img src="{{ url('/') }}/frontend/images/category/meat.jpg" alt="category">
                            <div class="category-overlay"><a href="shop-4column.html"><i class="fas fa-link"></i></a></div>
                        </div>
                        <div class="category-meta">
                            <h4>meat items</h4>
    ...
    <div class="container">
        ...
        <div class="brand-slider slider-arrow">
            <div class="brand-wrap">
                <div class="brand-media"><img src="{{ url('/') }}/frontend/images/brand/01.jpg" alt="brand">
            ...
            <div class="brand-wrap">
                <div class="brand-media"><img src="{{ url('/') }}/frontend/images/brand/02.jpg" alt="brand">
                    <div class="brand-overlay"><a href="brand-single.html"><i class="fas fa-link"></i></a></div>
                </div>
                <div class="brand-meta">
                    <h4>vegan lover</h4>
            ...
            <div class="brand-wrap">
                <div class="brand-media"><img src="{{ url('/') }}/frontend/images/brand/03.jpg" alt="brand">
                    <div class="brand-overlay"><a href="brand-single.html"><i class="fas fa-link"></i></a></div>
                </div>
                <div class="brand-meta">
                    <h4>organic foody</h4>
            ...
            <div class="brand-wrap">
                <div class="brand-media"><img src="{{ url('/') }}/frontend/images/brand/04.jpg" alt="brand">
                    <div class="brand-overlay"><a href="brand-single.html"><i class="fas fa-link"></i></a></div>
                </div>
                <div class="brand-meta">
            ...
            <div class="brand-wrap">
                <div class="brand-media"><img src="{{ url('/') }}/frontend/images/brand/05.jpg" alt="brand">
                    <div class="brand-overlay"><a href="brand-single.html"><i class="fas fa-link"></i></a></div>
                </div>
                <div class="brand-meta">
                    <h4>fresh fortune</h4>
            ...
            <div class="brand-wrap">
                <div class="brand-media"><img src="{{ url('/') }}/frontend/images/brand/06.jpg" alt="brand">
                    <div class="brand-overlay"><a href="brand-single.html"><i class="fas fa-link"></i></a></div>
                </div>
                <div class="brand-meta">
                    <h4>econature</h4>
                ...
                <div class="testimonial-slider slider-arrow">
                    <div class="testimonial-card"><i class="fas fa-quote-left"></i>
                        ...
                        <ul>
                            ...
                            <li class="fas fa-star"></li>
                            <li class="fas fa-star"></li>
                        </ul><img src="{{ url('/') }}/frontend/images/avatar/01.jpg" alt="testimonial"></div>
                    <div class="testimonial-card"><i class="fas fa-quote-left"></i>
                        <p>Lorem ipsum dolor consectetur adipisicing elit neque earum sapiente vitae obcaecati magnam doloribus magni provident ipsam</p>
                        <h5>mahmud hasan</h5>
                        <ul>
                            ...
                            <li class="fas fa-star"></li>
                            <li class="fas fa-star"></li>
                        </ul><img src="{{ url('/') }}/frontend/images/avatar/02.jpg" alt="testimonial"></div>
                    <div class="testimonial-card"><i class="fas fa-quote-left"></i>
                        <p>Lorem ipsum dolor consectetur adipisicing elit neque earum sapiente vitae obcaecati magnam doloribus magni provident ipsam</p>
                        <h5>mahmud hasan</h5>
                        <ul>
                            ...
                            <li class="fas fa-star"></li>
                            <li class="fas fa-star"></li>
                        </ul><img src="{{ url('/') }}/frontend/images/avatar/03.jpg" alt="testimonial"></div>
                    <div class="testimonial-card"><i class="fas fa-quote-left"></i>
                        <p>Lorem ipsum dolor consectetur adipisicing elit neque earum sapiente vitae obcaecati magnam doloribus magni provident ipsam</p>
                        <h5>mahmud hasan</h5>
                        <ul>
                            ...
                            <li class="fas fa-star"></li>
                            <li class="fas fa-star"></li>
                        </ul><img src="{{ url('/') }}/frontend/images/avatar/04.jpg" alt="testimonial"></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="blog-slider slider-arrow">
                    <div class="blog-card">
                        <div class="blog-media">
                            <a class="blog-img" href="#"><img src="{{ url('/') }}/frontend/images/blog/01.jpg" alt="blog"></a>
                        </div>
                    ...
                    <div class="blog-card">
                        <div class="blog-media">
                            <a class="blog-img" href="#"><img src="{{ url('/') }}/frontend/images/blog/02.jpg" alt="blog"></a>
                        </div>
                        <div class="blog-content">
                            <ul class="blog-meta">
                                <li><i class="fas fa-user"></i><span>admin</span></li>
                    ...
                    <div class="blog-card">
                        <div class="blog-media">
                            <a class="blog-img" href="#"><img src="{{ url('/') }}/frontend/images/blog/03.jpg" alt="blog"></a>
                        </div>
                        <div class="blog-content">
                            <ul class="blog-meta">
                                <li><i class="fas fa-user"></i><span>admin</span></li>
                    ...
                    <div class="blog-card">
                        <div class="blog-media">
                            <a class="blog-img" href="#"><img src="{{ url('/') }}/frontend/images/blog/04.jpg" alt="blog"></a>
                        </div>
                        <div class="blog-content">
                            <ul class="blog-meta">
                                <li><i class="fas fa-user"></i><span>admin</span></li>
