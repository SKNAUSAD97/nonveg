        ...
        <div class="row">
            <div class="col-sm-6 col-xl-3">
                <div class="footer-widget">
                    <a class="footer-logo" href="#"><img src="{{ url('/') }}/frontend/images/logo.png" alt="logo"></a>
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="footer-widget">
                    ...
                    <div class="footer-app">
                        <a href="#"><img src="{{ url('/') }}/frontend/images/google-store.png" alt="google"></a>
                        <a href="#"><img src="{{ url('/') }}/frontend/images/app-store.png" alt="app"></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="footer-bottom">
                    ...
                    <div class="footer-card">
                        <a href="#"><img src="{{ url('/') }}/frontend/images/payment/jpg/01.jpg" alt="payment"></a>
                        <a href="#"><img src="{{ url('/') }}/frontend/images/payment/jpg/02.jpg" alt="payment"></a>
                        <a href="#"><img src="{{ url('/') }}/frontend/images/payment/jpg/03.jpg" alt="payment"></a>
                        <a href="#"><img src="{{ url('/') }}/frontend/images/payment/jpg/04.jpg" alt="payment"></a>
                    </div>
                </div>
            </div>
        </div>
